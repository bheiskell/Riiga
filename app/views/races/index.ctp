...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $race['Race']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $race['Race']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $race['Race']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $race['Race']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
