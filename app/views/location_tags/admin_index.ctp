...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $locationTag['LocationTag']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $locationTag['LocationTag']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $locationTag['LocationTag']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $locationTag['LocationTag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
