  ...
  <tr<?php echo $class;?>>
    ...
    <td class="actions">
      ...
      <?php
        echo $html->link(
          __('Delete', true),
          array('action' => 'delete', $factionRank['FactionRank']['id']),
          null,
          sprintf(
...
<div class="actions">
  <ul>
    <li>
      <?php
        echo $html->link(__('New FactionRank', true), array('action' => 'add'));
      ?>
    </li>
    <li>
      <?php
        echo $html->link(
          __('List Factions', true),
          array('controller' => 'factions', 'action' => 'index')
        );
      ?> 
    </li>
    <li>
      <?php
        echo $html->link(
          __('New Faction', true),
          array('controller' => 'factions', 'action' => 'add')
        );
      ?> 
    </li>
    <li>
