...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $faction['Faction']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $faction['Faction']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $faction['Faction']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $faction['Faction']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
