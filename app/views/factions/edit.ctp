...
<?php echo $form->create('Faction');?>
	<fieldset>
 		<legend><?php __('Edit Faction');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('Faction.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Faction.id'))); ?></li>
